...
class DNSTofScOptionsView(DNSView):
    """
    ...
    def __init__(self, parent):
        ...
        self._map = {
            ...
            'substract_background_from_vanadium': self._content.
            cB_substract_background_from_vanadium,
        ...
        self._content.pB_get_wavelength.clicked.connect(self._get_wavelength)
