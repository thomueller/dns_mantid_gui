...
from mantidqtinterfaces.DNSReduction.plot.tof_powder_plot_model import DNSTofPowderPlotModel
from mantidqtinterfaces.DNSReduction.plot.tof_powder_plot_presenter import \
    DNSTofPowderPlotPresenter
from mantidqtinterfaces.DNSReduction.plot.tof_powder_plot_view import DNSTofPowderPlotView
...
class DNSTofPowderPlotPresenterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.presenter = DNSTofPowderPlotPresenter(view=cls.view,
                                                  model=cls.model,
                                                  parent=cls.parent)
        cls.presenter.param_dict = {
    ...
    @patch('DNSReduction.plot.tof_powder_plot_presenter.'
           'DNSTofPowderPlotPresenter._plot')
