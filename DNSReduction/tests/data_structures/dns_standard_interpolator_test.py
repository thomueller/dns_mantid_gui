...
import numpy as np
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import get_elastic_standard_datadic
...
class DNSStandardInterpolatorTest(unittest.TestCase):
    ...
    @patch('DNSReduction.data_structures.dns_standard_interpolator.DNSFile')
    ...
    @patch(
        'DNSReduction.data_structures.dns_standard_interpolator.'
        'read_standard_file')
    ...
    @patch('DNSReduction.data_structures.dns_standard_interpolator.'
           'create_dir')
    @patch('DNSReduction.data_structures.dns_standard_interpolator.'
           'create_array')
    @patch('DNSReduction.data_structures.dns_standard_interpolator.'
