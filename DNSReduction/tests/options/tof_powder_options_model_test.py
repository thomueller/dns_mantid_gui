...
from mantidqtinterfaces.DNSReduction.options.tof_powder_options_model import \
    DNSTofPowderOptionsModel
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import get_dataset, get_fake_tof_binning

from mantidqtinterfaces.DNSReduction.options import tof_powder_options_model
