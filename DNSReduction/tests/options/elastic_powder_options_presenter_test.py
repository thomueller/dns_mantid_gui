...
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import get_fake_param_dict
...
class DNSElasticPowderOptionsPresenterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.presenter = DNSElasticPowderOptionsPresenter(
            view=cls.view,
            model=cls.model,
            parent=cls.parent,
            name='elastic_powder_options')
    ...
    @patch('DNSReduction.options.elastic_powder_options_presenter.'
