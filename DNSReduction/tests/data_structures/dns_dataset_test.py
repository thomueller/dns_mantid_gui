...
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import get_fselector_fulldat

from mantidqtinterfaces.DNSReduction.data_structures.dns_dataset import (
...
class DNSDatasetTest(unittest.TestCase):
    ...
    @patch('DNSReduction.data_structures.dns_dataset.'
    ...
    @patch('DNSReduction.data_structures.dns_dataset.DNSBinning')
    ...
    def test_remove_non_measured_fields(self):
        ...
        self.assertEqual(testv[0]['filenumber'], 788058)
