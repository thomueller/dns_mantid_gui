...
from mantidqtinterfaces.DNSReduction.script_generator.tof_powder_script_generator_presenter \
    import DNSTofPowderScriptGeneratorPresenter
# yapf: enable
...
class DNSTofPowderScriptGeneratorWidget(DNSWidget):
    def __init__(self, name, parent):
        ...
        self.presenter = DNSTofPowderScriptGeneratorPresenter(
