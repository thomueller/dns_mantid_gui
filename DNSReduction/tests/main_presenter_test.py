...
class DNSReductionGUIPresenterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.parameter_abo.observer_dict = {'paths': dummy_observer,
    ...
    @patch('DNSReduction.main_presenter.DNSReductionGUIPresenter._switch_mode')
    @patch('DNSReduction.main_presenter.sys')
    def test_command_line_launch(self, mock_sys, mock_switch):
        ...
        self.command_line_reader.read.assert_called_with(
            [0, 0, '-tof', ''])
