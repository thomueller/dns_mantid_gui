...
class DNSPathView(DNSView):
    ...
    def __init__(self, parent):
        ...
        # for testing
        # self._content.lE_data_dir.setText('C:/data/tof')
        # self._content.lE_standards_dir.setText('
        # C:/data/nimnti_new_format/standards')
        # self._content.lE_script_dir.setText(
        #    'C:/data/nimnti_new_format/scripts')

        self._content.lE_data_dir.setText('C:/data/p13656')
        # self._content.lE_data_dir.setText('C:/data/mantid_test_hao')
        # self._content.lE_standards_dir.setText('C:/data/mantid_'
        #                                       'test_hao/standards')
        # self._content.lE_script_dir.setText(
        # 'C:/data/mantid_test_hao/scripts')
        # self._content.lE_export_dir.setText(
        # 'C:/data/mantid_test_hao/exports')
        # self._content.lE_data_dir.setText('C:/data/p13656')
