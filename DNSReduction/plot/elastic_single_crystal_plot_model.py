...
"""
import numpy as np
import mantidqtinterfaces.DNSReduction.plot.elastic_sc_helpers as helper
...
from mantidqtinterfaces.DNSReduction.plot.elastic_sc_helpers import get_hkl_intensity_from_cursor
...
class DNSElasticSCPlotModel(DNSObsModel):
    ...
    def get_format_coord(self, axis_type):
        ...
        def format_coord(x, y):
            ...
            return ('x={: 2.4f}, y={: 2.4f}, hkl=({: 2.2f},{: 2.2f},{: 2.2f}),'
                    ' Intensity={: 10.2f} ± {:10.2f}').format(
                x, y, h, k, l, z, error)
