...
from mantidqtinterfaces.DNSReduction.data_structures.dns_tof_powder_dataset import DNSTofDataset
from mantidqtinterfaces.DNSReduction.script_generator.common_script_generator_model import \
    DNSScriptGeneratorModel
from mantidqtinterfaces.DNSReduction.script_generator.tof_powder_script_generator_model import \
    DNSTofPowderScriptGeneratorModel
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import (get_fake_tof_options,
                                                    get_fselector_fulldat, get_paths)
...
class DNSTofPowderScriptGeneratorModelTest(unittest.TestCase):
    ...
    def test___init__(self):
        ...
        self.assertEqual(self.model._tof_opt['qstep'], 0.025)

    def test_validate_tof_options(self):
        self.assertTrue(self.model._validate_tof_options())
        self.model._tof_opt['dEstep'] = 0
        self.assertFalse(self.model._validate_tof_options())
        self.model._tof_opt['dEstep'] = 1
        self.model._tof_opt['qstep'] = 0
        self.assertFalse(self.model._validate_tof_options())
        self.model._tof_opt['qstep'] = 1
        self.model._tof_opt['qmax'] = -100
        self.assertFalse(self.model._validate_tof_options())
        self.model._tof_opt['qmax'] = 100
        self.model._tof_opt['dEmax'] = -100
        self.assertFalse(self.model._validate_tof_options())
        self.model._tof_opt['dEmax'] = 100
        self.assertTrue(self.model._validate_tof_options())
    ...
    def test_validate_nb_empty_banks(self):
        ...
        self.assertTrue(self.model._validate_nb_empty_banks())
        self.model._tof_opt['corrections'] = 1
        self.model._tof_opt['substract_vana_back'] = 0
        self.assertFalse(self.model._validate_nb_empty_banks())
        self.model._tof_opt['substract_sample_back'] = 0
        self.assertTrue(self.model._validate_nb_empty_banks())
        self.model._tof_opt['substract_vana_back'] = 1
        self.assertFalse(self.model._validate_nb_empty_banks())
        self.model._tof_opt['substract_vana_back'] = 0
        self.model._tof_opt['corrections'] = 0
        self.assertTrue(self.model._validate_nb_empty_banks())
    ...
    def test_validate_nb_vana_banks(self):
        ...
        self.assertTrue(self.model._validate_nb_vana_banks())
        self.model._tof_opt['corrections'] = 1
        self.model._tof_opt['det_efficency'] = 0
        self.assertTrue(self.model._validate_nb_vana_banks())
        self.model._tof_opt = get_fake_tof_options()
    ...
    def test_check_vana_cor(self):
        ...
        self.model._tof_opt['det_efficency'] = 0
        self.assertFalse(self.model._check_vana_cor())
        self.model._tof_opt['det_efficency'] = 1
        self.model._tof_opt['corrections'] = 0
        self.assertFalse(self.model._check_vana_cor())
        self.model._tof_opt = get_fake_tof_options()
    ...
    def test_get_binning_lines(self):
        ...
        self.assertIsInstance(testv, list)
        self.assertEqual(len(testv), 2)
        teststring = ("bins = {'qmin' :   0.185, 'qmax' :   2.837, 'qstep' :"
                      "   0.025,\n        'dEmin':  -3.641, 'dEmax':   3.641,"
                      " 'dEstep':   0.073}")
        self.assertEqual(testv[0], teststring)
    ...
    def test_get_header_lines(self):
        ...
        self.assertEqual(testv[0][0:6], 'import')
    ...
    def test_get_substract_empty_lines(self):
        ...
        testv = self.model._get_substract_empty_lines()
        self.assertIsInstance(testv, list)
        self.assertFalse(testv)
        self.model._tof_opt['substract_sample_back'] = False
        ...
        self.model._tof_opt['substract_sample_back'] = True
        testv = self.model._get_substract_empty_lines()
    ...
    def test_setup_sample_data(self):
        fselector = get_fselector_fulldat()
        paths = get_paths()
