...
class CommandLineReaderTest(unittest.TestCase):
    ...
    @patch('DNSReduction.command_line.command_check.'
           'CommandLineReader._parse_file_command')
    def test_read(self, mock_parse):
        # sc elastic
        mock_parse.return_value = ['786359', '788058', '100']
        cla = ('-files p164260000 100 2 786359 788058'
        ...
        cla = ('-powder -files p164260000 0 2 786359 788058'
               ' 4p1K_map.d_dat -xyz -sep-nonmag -tof').split(' ')
        self.colire.read(cla)
    ...
    @patch('DNSReduction.command_line.command_check.DNSFile')
    ...
    @patch('DNSReduction.command_line.command_check.os.path.isfile')
