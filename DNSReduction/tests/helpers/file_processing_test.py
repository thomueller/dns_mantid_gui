...
from mantidqtinterfaces.DNSReduction.helpers.file_processing import (create_dir, filter_filenames,
                                                  return_filelist,
                                                  return_standard_zip,
                                                  save_txt,
                                                  ...
                                                  get_path_and_prefix)
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import get_3filenames


def mock_mtime(filename):
    times = {'standard.zip': 5,
             'standard123.zip': 4}
...
class DNSfile_processingTest(unittest.TestCase):
    ...
    @patch('DNSReduction.helpers.file_processing.'
           'os.listdir')
    @patch('DNSReduction.helpers.file_processing.'
           'os.path.isdir')
    ...
    @patch('DNSReduction.helpers.file_processing.'
           'os.path.getmtime', new=mock_mtime)
    @patch('DNSReduction.helpers.file_processing.'
           'glob.glob')
    @patch('DNSReduction.helpers.file_processing.'
           'os.path.isdir')
