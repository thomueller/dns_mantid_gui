...
class DNSPathModelTest(unittest.TestCase):
    ...
    @patch('DNSReduction.paths.path_model.DNSFile')
    @patch('DNSReduction.paths.path_model.glob.iglob')
    ...
    @patch('DNSReduction.paths.path_model.os.remove')
    @patch('DNSReduction.paths.path_model.os.path.isfile')
    ...
    def test_get_startpath_for_dialog(self):
        testv = self.model.get_startpath_for_dialog('')
        self.assertEqual(testv, expanduser("~"))
        testv = self.model.get_startpath_for_dialog('1')
