...
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import (get_fake_empty_param_dict,
                                                    get_fake_param_dict, get_filepath)
...
class DNSScriptGeneratorPresenterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.presenter = DNSScriptGeneratorPresenter(
            view=cls.view,
            model=cls.model,
            name='common_script_generator',
            parent=cls.parent)
    ...
    def test___init__(self):
        ...
        self.assertEqual(self.presenter._scripttext, '')
    ...
    def test_get_sampledata(self):
        testv = self.presenter._get_sampledata()
        self.assertEqual(testv[0]['filenumber'], '787463')
        self.presenter.param_dict = get_fake_empty_param_dict()
        self.assertFalse(self.presenter._get_sampledata())
    ...
    def test_save_script(self):
        ...
        self.model.save_script.assert_called_once_with('', 'script.txt',
                                                       '123')
