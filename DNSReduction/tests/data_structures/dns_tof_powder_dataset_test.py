...
from mantidqtinterfaces.DNSReduction.tests.helpers_for_testing import (get_fake_tof_datadic,
                                                    get_fselector_fulldat)
from mantidqtinterfaces.DNSReduction.data_structures import dns_tof_powder_dataset
...
class DNSTofDatasetTest(unittest.TestCase):
    ...
    def test__get_path_string(self):
        testv = dns_tof_powder_dataset._get_path_string(
            {'a': {'path': '123'}}, 'a')
